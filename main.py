...
def parse_args():
    ...
    parser.add_argument('--accumulation_steps', type=int, default=20, help='梯度传播参数')
    ...
    parser.add_argument('--checkpoint', type=str, default='/work/20221209_Aerial_Photograph/checkpoint_pth/1210', help='checkpoint save pth')
    parser.add_argument('--resume_train', type=str, default='', help='Weights resumed in training')
    parser.add_argument('--resume', type=str, default='/work/20221209_Aerial_Photograph/checkpoint_pth/1210/weights_hrsc/model_best.pth', help='Weights resumed in testing and evaluation')
    parser.add_argument('--dataset', type=str, default='hrsc', help='Name of dataset')
    parser.add_argument('--data_dir', type=str, default='/work/20221209_Aerial_Photograph/data/hrsc', help='Data directory')
